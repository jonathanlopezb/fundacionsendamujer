...
export const metadata: Metadata = { title: 'Programas para mujeres', description: 'Conoce los programas de Fundación Senda Mujer para protección, salud, derechos, acompañamiento y autonomía en Cartagena.', alternates: { canonical: '/programas' } };
import { ArrowRight, BriefcaseBusiness, Scale } from 'lucide-react';
import ProgramsGrid from '@/components/ProgramsGrid';
import CamDonorPitch from '@/components/CamDonorPitch';
