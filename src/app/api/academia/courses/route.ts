    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'emp-1', title: '1.1 Identificación de Oportunidades Locales', duration: '15 min', isPreview: true },
          { id: 'emp-2', title: '1.2 Validación Rápida con Clientes Reales', duration: '20 min' },
        ],
      },
      {
        title: 'Módulo 2 — Mis Números y Finanzas Clave',
        lessons: [
          { id: 'emp-3', title: '2.1 Costos Fijos vs Variables', duration: '22 min' },
          { id: 'emp-4', title: '2.2 Cómo Fijar el Precio de Venta', duration: '18 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'lid-1', title: '1.1 Descubriendo tu Estilo de Liderazgo', duration: '16 min', isPreview: true },
          { id: 'lid-2', title: '1.2 Vencer el Miedo a Hablar en Público', duration: '19 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'fin-1', title: '1.1 Dónde se va mi dinero cada mes', duration: '14 min', isPreview: true },
          { id: 'fin-2', title: '1.2 Creación del Presupuesto Familiar', duration: '22 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'der-1', title: '1.1 Tipos de Violencia y Manifestaciones', duration: '18 min', isPreview: true },
          { id: 'der-2', title: '1.2 Rutas de Atención Institucional en Cartagena', duration: '24 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'can-1', title: '1.1 Interfaz y Herramientas Esenciales', duration: '12 min', isPreview: true },
          { id: 'can-2', title: '1.2 Creación de tu Identidad Visual', duration: '20 min' },
        ],
      },
    ],
  },
