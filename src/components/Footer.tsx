...
export default function Footer() {
  return <footer className="senda-footer">
    <div className="senda-footer__top"><div className="senda-footer__brand"><div><Image src="/logo.png" alt="Fundación Senda Mujer" fill className="object-contain" sizes="180px"/></div><p>Acompañamiento, protección y fortalecimiento integral para mujeres y niñas en Cartagena.</p><strong>“Ninguna mujer debería enfrentar sola su camino.”</strong></div>
      ...
      <div><h3>Conoce más</h3><Link href="/nosotros">Quiénes somos</Link><Link href="/caribe-seguro/aliados">Aliados</Link><Link href="/galeria">Galería</Link><Link href="/donar">Donaciones</Link></div>
